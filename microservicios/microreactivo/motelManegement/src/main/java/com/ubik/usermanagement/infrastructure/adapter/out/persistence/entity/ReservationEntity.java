...
/**
 * Entidad de persistencia para Reservation
 * Representa la tabla reservations en la base de datos
 */
@Table("reservation")
public record ReservationEntity(
        ...
        @Column("check_in_date") LocalDateTime checkInDate,
        @Column("check_out_date") LocalDateTime checkOutDate,
        String status,
